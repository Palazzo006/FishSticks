...
public class GameWindow extends JFrame {
    ...
    private void initializeComponents() {
        ...
        setGameBackground("images/underwaterintro.gif");
    ...
    private void setGameBackground(String imagePath) {
        ImageIcon bgIcon = new ImageIcon(new ImageIcon(imagePath).getImage().getScaledInstance(800, 600, Image.SCALE_DEFAULT));
    ...
    private void startGame() {
        ...
        setGameBackground("images/underwaterbackground.png");
